...
var R_format_offcet_type = {'1':'50', '2':'90', '3':'130', '4':'160'};
...
var K_format_type = {
	'1':{'1':'0.125', '2':'0.13', '3':'0.17', '4':'0.2'}
	,'2':{'1':'0.15', '2':'0.16', '3':'0.18', '4':'0.22'}
	,'3':{'1':'0.17', '2':'0.18', '3':'0.2', '4':'0.24'}
	,'4':{'1':'0.2', '2':'0.21', '3':'0.22', '4':'0.27'}
	,'5':{'1':'0.23', '2':'0.24', '3':'0.25', '4':'0.31'}
	,'6':{'1':'0.26', '2':'0.27', '3':'0.29', '4':'0.35'}
	,'7':{'1':'0.31', '2':'0.32', '3':'0.34', '4':'0.42'}
	,'8':{'1':'0.4', '2':'0.41', '3':'0.45', '4':'0.52'}
	,'9':{'1':'0.49', '2':'0.5', '3':'0.52', '4':'0.64'}
	,'10':{'1':'0.09', '2':'0.12', '3':'0.13', '4':'0.15'}
	,'11':{'1':'0.11', '2':'0.13', '3':'0.15', '4':'0.17'}
	,'12':{'1':'0.13', '2':'0.15', '3':'0.18', '4':'0.22'}
	,'13':{'1':'0.24', '2':'0.24', '3':'0.27', '4':'0.31'}
	,'14':{'1':'0.28', '2':'0.32', '3':'0.36', '4':'0.42'}
	,'15':{'1':'0.07', '2':'0.08', '3':'0.09', '4':'0.1'}
	,'16':{'1':'0.089', '2':'0.1', '3':'0.11', '4':'0.12'}
	,'17':{'1':'0.85', '2':'0.85', '3':'0.85', '4':'0.85'}
};
...
var H1_format_type = {
	'1':{'1':'0.05', '2':'0.045', '3':'0.04', '4':'0.035', '5':'0.033', '6':'0.031', '7':'0.03'}
	, '2':{'1':'0.35', '2':'0.32', '3':'0.3', '4':'0.29', '5':'0.28', '6':'0.25', '7':'0.24'}
};	

var I1_format_type = {
	'1':{'1':'0.05', '2':'0.045', '3':'0.04', '4':'0.035', '5':'0.033', '6':'0.031', '7':'0.029'}
	, '2':{'1':'0.41', '2':'0.37', '3':'0.35', '4':'0.3', '5':'0.3', '6':'0.3', '7':'0.23'}
};	
...
function build_calculator(params) {
	...
	if (params['CLC'] == 1) {
		//ќфсетов печат (големи тиражи)
/*		
Y=(Q/(T/2) (“” за корица)				
цена за печат на корица=((B+C)*V)+D				
цена за харти€ на корица=((Y+R)/4)*E				
покритие на корица=((Y+(R/3))*F)+X				
Z=G/T (коли 35х50)				
цена за печат на т€лото=(((H+I)*W)*Z)+J			

[14:24:16] Valio: цена за печат на т€лото=(((H+I)*W)*(Z/2))+J
	
цена за харти€ на т€лото=(((Q+U)/4)*(Z/2))* 				
цена за покритие на т€лото=(((Q+(U/3))*(Z/2))*L)+XX				
...
/*
	...
	*/
		...
		//ƒигитален печат (малки тиражи)

/*
Y=(Q/(T/2) (“” за корица)				
цена за печат на корица=(B+C)*Q				
цена за харти€ на корица=((Y+4)/4)*E				
покритие на корица=((Y+4)*F)+X				
Z=G/T (коли A3)				
цена за печат на т€лото=((H+I)*(Z/2)*Q				
цена за харти€ на т€лото=((Q+4)*(Z/2))*( /4)				
цена за покритие на т€лото=(((Q+4)*(Z/2))*L)+D				

цена за работа=(((G/(T*2))*0,006)*Q)+(Q*M) 
јко   е над 150 гр. ‘ормулата за цена за работа става:  
...
//W=Z*Q
/* 22.09.2018
цена за печат на корица=(B+C)*Y - старата формула е (B+C)*Q 
цена за покритие на т€лото=(((Q+4)*Z)*L)+D - старата формула е (((Q+4)*Z/2)*L)+D
цена за работа=(((G/(T*2))*0,006)*Q)+(Q*M)+R - старата формула е (((G/(T*2))*0,006)*Q)+(Q*M)
ƒобав€не R в зависимост от M
 */
	var Y = 0;
	var print_cover_price = print_paper_price = print_cover_price1 = Z = print_body_price = print_body_paper_price = 0;
	var print_cover_body_price = print_work_price = print_prepress_price = 0;
	...
	Y = params['Y'];
	//params['Y'];
	print_cover_price = ((params['B']+params['C'])*params['Y']);
...
//	print_cover_body_price = ((((params['Q']+4)*(Z/2))*params['L'])+params['D']);
	print_cover_body_price = ((((params['Q']+4)*Z)*params['L'])+params['D']);
  ...
  if (params['M'] == 2) {
	...
	if (params['FM'] == 2) {
		//цена за работа=(((G/(T*2))*0,014)*Q)+(Q*M)
		print_work_price = ((((params['G']/(params['T']*2))*0.012)*params['Q'])+(params['Q']*params['M'])) + params['R'];
	} else {
		print_work_price = ((((params['G']/(params['T']*2))*0.006)*params['Q'])+(params['Q']*params['M'])) + params['R'];
	}
	...
	var __info = 'цена за печат на корица= '+print_cover_price+'<br>';
			__info += 'цена за харти€ на корица= '+print_paper_price+'<br>';
			__info += 'Y='+Y+'<br>';
			__info += 'покритие на корица= '+print_cover_price1+'<br>';
			__info += 'Z= '+Z+'<br>' ;
			__info += 'цена за печат на т€лото= '+print_body_price+'<br>';
			__info += 'цена за харти€ на т€лото= '+print_body_paper_price+'<br>';
			__info += 'цена за покритие на т€лото= '+print_cover_body_price+'<br>';
